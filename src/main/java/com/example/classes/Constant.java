...
public class Constant {
    ...
    public static int Lateness(int x) { return 5*x; } //hàm tính chi phí thiệt hại nếu đến quá sớm hoặc quá trễ
    public static int SAFE_DISTANCE() { return 46; }
    public static int DELTA_T() { return 10; }
