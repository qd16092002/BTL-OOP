    ...
    public void move(AutoAgv agv) {
        ...
        if (agv.cur == agv.path.length - 1) {
            ...
            if (this._isLastMoving) {
                ...
                agv.hybridState = new IdleState(currentTimeMillis());
            }
            return;
        }
        ...
        if (nodeNext.state == StateOfNode2D.BUSY || shortestDistance < Constant.SAFE_DISTANCE()) {
             ...
             */
            if (agv.waitT > 0) {
                agv.curNode.setU((currentTimeMillis() - agv.waitT) / 1000);
                /*
                 * agv.scene.forcasting.
            ...
            if (agv.x != nodeNext.x * 32 || agv.y != nodeNext.y * 32) {
                ...
                if (agv.sobuocdichuyen % 10 == 0 || currentTimeMillis() - agv.thoigiandichuyen > 10000) {
                    agv.thoigiandichuyen = currentTimeMillis();
                    agv.cur = 0;
